...
public class Carnivore {
    ...
    public Carnivore(int id, int[] position, Random random){
    ...
    public void move(){
        ...
        Game_field.game_field[old_position[0]][old_position[1]]="-"; // implement not consuming grasssssss
        Game_field.game_field[new_position[0]][new_position[1]]="C"; // implement taking into account what type of tile has been stepped on
    ...
    public void eat(){
        ...
        for(int[] coordinates:surroundings){
            if (Game_field.game_field[coordinates[0]][coordinates[1]].equals("H")){
                Game_field.getHerbivoreByPosition(coordinates).die();
